<div class="box box-borderless full-in-small">
    <div class="box-header with-border">
        ...
        @auth
            ...
            <div class="form-horizontal show-form-data">
                ...
                <div class="form-group margin-bottom-none">
                    <label class="col-xs-6 font-light margin-bottom-none">{{ __('Highest Bid') }}:</label>
                    <div class="col-xs-6">
                        <div class=" text-right">
    ...
    <div class="box-body">
        <form method="post" action="{{ route('trader.orders.store') }}" id="sell_order_form"
            ...
            <input type="hidden" value="{{ EXCHANGE_SELL }}"
            ...
            @auth
                <button class="btn btn-success btn-sm btn-block form-submission-button">{{ __('SELL') }}</button>
            @endauth
