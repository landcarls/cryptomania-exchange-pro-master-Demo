...
Route::get('exchange-dark', function () {
    return view('exchange-dark');
}); 

Route::get('settings-dark', function () {
    return view('settings-dark');
});

Route::get('settings-profile-dark', function () {
    return view('settings-profile-dark');
});

Route::get('settings-wallet-dark', function () {
    return view('settings-wallet-dark');
});
